...
class TestLogin(BaseTest):
    ...
    def test_verify_login_ui_elements(self):
        ...
        self.driver.save_screenshot("verify_login_ui_elements.png")
    ...
    def test_placeholders(self):
        ...
        self.driver.save_screenshot("test_placeholders.png")
    ...
    def test_login_valid_credentials(self):
        ...
        self.driver.save_screenshot("valid_login_successfully.png")
    ...
    def test_login_invalid_credentials(self):
        ...
        self.driver.save_screenshot("login_invalid_credentials.png")
    ...
    def test_login_valid_email_invalid_password(self):
        ...
        assert login_page.is_error_message_displayed()
        self.driver.save_screenshot("login_valid_email_invalid_password.png")
    ...
    def test_invalid_email_format(self):
        ...
        self.driver.save_screenshot("invalid_email_format.png")
    ...
    def test_blank_fields(self):
        ...
        self.driver.save_screenshot("blank_fields.png")
    ...
    def test_email_only(self):
        ...
        assert login_page.is_password_displayed()
        assert ConfigReader.get_error_message("password_required") in login_page.get_password_error_text()
        self.driver.save_screenshot("email_only.png")
    ...
    def test_password_only(self):
      ...
      assert login_page.is_email_displayed()
      assert ConfigReader.get_error_message("email_required") in login_page.get_email_error_text()
      self.driver.save_screenshot("password_only.png")
    ...
    def test_enter_key_login(self):
        ...
        login_page.wait_for_dashboard()
        assert "Dashboard" in login_page.get_dashboard_title_text()
        self.driver.save_screenshot("Press ENTER.png")
